...
export const STATE_RULES: Record<string, StateWaiverRule> = {
  AZ: {
    ...
    notes: 'Arizona requires mandatory statutory forms for all 4 waiver types. Any modification to the statutory form language invalidates the waiver. Advance waivers prohibited. Dedicated template active — body language tracks A.R.S. § 33-1008. Requires confirmation under current Arizona law.',
  ...
  FL: {
    ...
    complianceStatus: 'compliant',
    prohibitsAdvanceWaivers: true,
    notes: 'CRITICAL: Florida SB 658 (eff. July 1, 2025) requires forms IDENTICAL to statutory forms in § 713.20(4) and (5). Requires notarization. Advance waivers unenforceable. Dedicated template active — body language tracks Fla. Stat. § 713.20. Requires confirmation under current Florida law.',
    requiredFields: ['claimant_name', 'customer_name', 'job_location', 'owner_name', 'through_date', 'amount'],
    warningText: {},
  },
  GA: {
  ...
  NV: {
    ...
    complianceStatus: 'compliant',
    prohibitsAdvanceWaivers: true,
    notes: 'Nevada requires mandatory statutory forms. Unconditional waivers MUST be notarized (NRS § 108.2457). Advance waivers are void. Dedicated template active — body language tracks NRS § 108.2457. Requires confirmation under current Nevada law.',
    requiredFields: ['claimant_name', 'customer_name', 'job_location', 'owner_name', 'through_date', 'amount'],
    warningText: {},
  },
  NY: {
  ...
  TX: {
    ...
    complianceStatus: 'compliant',
    prohibitsAdvanceWaivers: true,
    notes: 'Texas HAS statutory waiver forms (Tex. Prop. Code § 53.284). Waivers must substantially comply with statutory forms. Requires notarization (affidavit format). Advance waivers void. Preliminary notice requirements (monthly notices for non-original contractors) interact with waiver validity. Dedicated template active — body language tracks Tex. Prop. Code § 53.284. Requires confirmation under current Texas law.',
    requiredFields: ['claimant_name', 'customer_name', 'job_location', 'owner_name', 'through_date', 'amount'],
    warningText: {},
  },
  ...
  MI: {
    ...
    complianceStatus: 'compliant',
    prohibitsAdvanceWaivers: true,
    notes: 'Michigan prescribes statutory waiver forms (MCL § 570.1115). Supports Conditional/Unconditional × Full/Partial. Notary recommended but not required. Advance waivers restricted. Contractor sworn statement may be required (MCL § 570.1110). Dedicated template active — body language tracks MCL § 570.1115. Requires confirmation under current Michigan law.',
    requiredFields: ['claimant_name', 'customer_name', 'job_location', 'owner_name', 'through_date', 'amount'],
    warningText: {},
  },
  MO: {
    ...
    complianceStatus: 'compliant',
    prohibitsAdvanceWaivers: false,
    notes: 'Missouri has prescribed waiver forms (Mo. Rev. Stat. § 429.005). Must substantially conform. Residential vs commercial distinction may apply. Dedicated template active — body language tracks Mo. Rev. Stat. § 429.005. Requires confirmation under current Missouri law.',
    requiredFields: ['claimant_name', 'customer_name', 'job_location', 'owner_name', 'through_date', 'amount'],
    warningText: {},
  },
  MS: {
    ...
    complianceStatus: 'compliant',
    prohibitsAdvanceWaivers: true,
    notes: 'Mississippi prescribes statutory waiver forms (Miss. Code § 85-7-405). Supports Conditional/Unconditional × Interim/Final. Notary recommended but not required. Advance waivers void. Dedicated template active — body language tracks Miss. Code § 85-7-405. Requires confirmation under current Mississippi law.',
    requiredFields: ['claimant_name', 'customer_name', 'job_location', 'owner_name', 'through_date', 'amount'],
    warningText: {},
  },
  UT: {
    ...
    complianceStatus: 'compliant',
    prohibitsAdvanceWaivers: true,
    notes: 'Utah prescribes 4 standard waiver types (Utah Code § 38-1a-802). State Construction Registry (SCR) filing may interact with waiver requirements. Advance waivers restricted. Dedicated template active — body language tracks Utah Code § 38-1a-802. Requires confirmation under current Utah law.',
    requiredFields: ['claimant_name', 'customer_name', 'job_location', 'owner_name', 'through_date', 'amount'],
    warningText: {},
  },
  WY: {
    ...
    complianceStatus: 'compliant',
    prohibitsAdvanceWaivers: false,
    notes: 'Wyoming waivers must conform to statutory requirements (Wyo. Stat. § 29-2-110). Dedicated template active — body language tracks Wyo. Stat. § 29-2-110. Requires confirmation under current Wyoming law.',
    requiredFields: ['claimant_name', 'customer_name', 'job_location', 'owner_name', 'through_date', 'amount'],
    warningText: {},
  },
