...
const styles = StyleSheet.create({
  ...
  notice: {
    // CA law: NOTICE must appear "in type at least as large as the largest type" in the form.
    // Title is 13pt, so NOTICE must be >= 13pt. Using 14pt to be safely compliant.
    fontSize: 14,
    fontWeight: 'bold',
    fontFamily: 'Helvetica-Bold',
    marginBottom: 20,
  ...
  return (
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        {/* No footer on CA statutory forms — adding non-statutory text can void the waiver */}
      </Page>
    </Document>
  )
}
