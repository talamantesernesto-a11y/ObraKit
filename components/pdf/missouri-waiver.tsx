...
// Missouri Mo. Rev. Stat. § 429.005 et seq.
// Prescribed waiver forms — must substantially conform.
// Residential vs commercial projects may have different rules.
// No notarization required.
// Requires confirmation under current Missouri law.
...
export function MissouriWaiver(data: WaiverPdfData) {
  ...
  return (
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Text style={styles.statuteRef}>{STATE_RULES.MO.statuteReference}</Text>

        {/* Missouri residential/commercial note */}
        <View style={styles.noteBox}>
          <Text style={styles.noteText}>
            NOTE: Missouri law may apply different rules for residential vs commercial projects. Verify with counsel which rules apply to this project.
          </Text>
        </View>

        {/* Identifying fields — per Mo. Rev. Stat. § 429.005 statutory form structure */}
        ...
        {/* Body language — tracks Mo. Rev. Stat. § 429.005 statutory forms */}
        {/* Requires confirmation under current Missouri law */}
